...
INSERT INTO `Employee` (`First_name`, `Last_name`, `occupation`, `username`, `password`) VALUES
('Usman', 'Yousaf', 'Pharmacist', 'admin', 'admin123'),
('Zainab', 'Malik', 'Sales Assistant', 'zainab', 'pass123');
